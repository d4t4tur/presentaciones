...
+ El flujo de viajeros se distribuyo de manera más heterogénea ene el último lustro.

+ Sin embargo, la demanda mantiene alto nivel de concentración.

+ La Ciudad de Buenos Aires es el principal destino de los viajes.

## Oferta

+ La oferta de plazas apenas varió en el último lustro y se encuentra apenas concentrada.

+ La provincia de Buenos Aires es el distrito de mayor n° de plazas disponibles.
