...
knitr::include_graphics("imgs/pib_mundial.png")
```
...
```{r , echo = FALSE, out.width='100%'}
knitr::include_graphics("imgs/ind_arg.png")
```
---
...
```{r , echo = FALSE}
knitr::include_graphics("imgs/indec.png")
```
---

```{r , echo = FALSE}
knitr::include_graphics("imgs/indec0.png")
```
---

```{r , echo = FALSE}
knitr::include_graphics("imgs/indec1.png")
```

---

```{r , echo = FALSE, out.width='100%'}
knitr::include_graphics("imgs/indec2.png")
```

---

```{r , echo = FALSE, out.width='100%'}
knitr::include_graphics("imgs/indec3.png")
```

---

```{r , echo = FALSE}
knitr::include_graphics("imgs/indec4.png")
```
...
.pull-left[
```{r,  echo = FALSE, out.width='100%'}
knitr::include_graphics("imgs/emae_junio.png")
```
]

.pull-right[
```{r,  echo = FALSE,  out.width='100%'}
knitr::include_graphics("imgs/emae_meses.png")
```
]
---
