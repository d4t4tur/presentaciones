...
*Mar del Plata, 29 de septiembre*
<br>
<br>
<br>
]
...
---
```{r echo=FALSE}
knitr::include_graphics("imgs/roseta.png")
```

---
```{r echo=FALSE}
knitr::include_graphics("imgs/roceta_1.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/roceta_2.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/roceta_3.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/roceta_4.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/roceta_5.png")
```
---
...
---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_1.png")
```
...
knitr::include_graphics("imgs/informe1.png")
```

---
```{r echo=FALSE, out.width='65%', fig.align="center"}
knitr::include_graphics("imgs/informe2.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_2.png")
```
<br>
.footnote[<span style="background-color:#37bbed">https://www.yvera.tur.ar/sinta/informe/info/cuenta-satelite-de-turismo</span>]
---
```{r echo=FALSE, out.width='65%', fig.align="center"}
knitr::include_graphics("imgs/csta1.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_3.png")
```
<br>
...
knitr::include_graphics("imgs/armonizacion1.png")
```
---
###ARMONIZACIÓN: https://armonizacion.yvera.tur.ar/

```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/armonizacion2.png")
```
---
### <dataTUR>

```{r echo=FALSE, out.width='65%', fig.align="center"}
knitr::include_graphics("imgs/datatur.png")
```
---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_4.png")
```
<br>
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/datos1.png")
```
---
###DATOS ABIERTOS: https://datos.yvera.gob.ar/
...
---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_5.png")
```
<br>
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros1.png")
```
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros2.png")
```
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros3.png")
```
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros4.png")
```
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros5.png")
```
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/tableros6.png")
```

---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_6.png")
```
<br>
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/biblioteca2.png")
```

---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_7.png")
```
<br>
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/bitacora1.png")
```

---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_8.png")
```
<br>
...
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/calendario1.png")
```

---
```{r echo=FALSE}
knitr::include_graphics("imgs/fit/sinta_9.png")
```
---
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/sintia1.png")
```
---
```{r echo=FALSE, out.width='75%', fig.align="center"}
...
---
```{r echo=FALSE, out.width='75%', fig.align="center"}
knitr::include_graphics("imgs/sintia3.png")
```
---
